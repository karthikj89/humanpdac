# Whole transcriptome digital single nucleus profiling of pancreatic cancer
...
Our manuscript (in press at Nature Genetics) will be available soon. The preprint can be found [here](https://www.biorxiv.org/content/10.1101/2020.08.25.267336v1.full). Raw and processed data can be found at GEO under accession number GSE199102. Code for the DSP analysis can be found [here](https://github.com/whwanglab/PDAC).
